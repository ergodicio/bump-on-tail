"""Driver: two-mode mixing IC sweep — Landau-damped regime.

Generates bot/figures/fig_twomode_sweep.png.
Requires bot/runs/sweep_twomode.npz — run python -m bot.sweeps.sweep_twomode first if missing.
"""

from pathlib import Path
from bot.figures_u2 import fig_twomode_sweep
