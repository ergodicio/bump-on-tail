"""Driver: two-mode mixing IC sweep — growing beam regime.

Generates bot/figures/fig_twomode_sweep_growing.png.
Requires bot/runs/sweep_twomode_growing.npz — run python -m bot.sweeps.sweep_twomode_growing first if missing.
"""

from pathlib import Path
from bot.figures_u2 import fig_twomode_sweep_growing
